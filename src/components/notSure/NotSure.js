  ...
  return (
    <div className="px-5 my-16 p-3 lg:p-7  md:text-xl lg:mt-24 lg:flex justify-evenly">
      ...
      <div className="hidden lg:block lg:-[100%] lg:w-[35%] lg:relative ">
        <img src={pattern} alt="patern img" className="lg:h-[70%] lg:w-[65%] lg:absolute bottom-0 left-0 lg:-z-0 " />
        <img src={group} alt="patern" className="lg:h-[85%] lg:w-[80%] lg:absolute top-0 right-0 " />
      </div>
