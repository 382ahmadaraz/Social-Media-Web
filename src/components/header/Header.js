    ...
    <div className=''>
      ...
      <div className="header-section  p-2 sm:px-4 lg:flex items-center justify-around  ">
        ...
        <div className="header-text  px-5 sm:mt-3 sm:p-2 md:px-9 lg:px-0 lg:w-[45%] lg:font-semibold ">
          ...
          <Button title="Start Today"   /><Link to={"/login"}>
            <div className="   ml-4 lg:ml-7 flex items-center cursor-pointer text-pink-700">
              <img src={h3} alt="arrow" className="border-2 border-pink-600 mr-1 sm:p-2 lg:p-2 lg:rounded-md lg:mr-3" />
              <p className=' hidden sm:block sm:text-lg'>Book a Demo Today</p>
            </div></Link>
          </div>
        </div>
        <div className="header-image mt-3 p-4 sm:px-20 sm:hidden md:block md:p-9 md:mt-0 md:px-36 lg:p- lg:px-0 lg:w-[40%] relative">
          <img src={h2} alt="h1" className="h-[80px] absolute left-0 top-[10%] sm:h-[100px] sm:left-[8%] md:h-[140px] md:top-[20%] md:left-[12%] lg:h-[120px] lg:top-[10%] lg:left-[-6%] z-10 "/>
