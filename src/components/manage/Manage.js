  ...
  return (
    <div className=" my-20  lg:mt-24 px-4 lg:flex justify-center lg:items-center relative">
      ...
      <div className="manage-image hidden lg:block lg:w-[40%] lg:h-[80%]    ">
        <img src={m1} alt="lower-Image" className="rounded-md absolute top-[10%] lg:mt-[55px] z-[-1] lg:w-[30%] lg:h-[55%] xl:h-[65%] "/>
        <img src={m2} alt="upper-image" className="rounded-md z-[2] lg:w-[90%] lg:hdden  lg:h-[100%] lg:float-end" />
      </div>
      ...
      <div className="p-4 lg:w-[53%] lg:p-0 lg:pl-5  md:text-md lg:text-md 2xl:text-xl 2xl:[&>*]:my-11   ">
        ...
        {/* manage icons */}
         <div className="mt-3 lg:my-2 flex  ">
            ...
            <div className="p-2 md:px-4   lg:ml-3 lg:px-0">
                ...
                <p className="text-gray-700 lg:text-md">Schedule and publish content to all of your social profiles, track effectiveness in real time.</p>
            </div>
        </div>
        <div className="mt-3  lg:my-2  flex">
            ...
            <div className="p-2 md:px-4  lg:ml-3 lg:px-0">
                ...
                <p className="text-gray-700 lg:text-md">View all of your social media content in one calendar. Easily see all your scheduled and published content.</p>
            </div>
        </div>
        <div className="mt-3  lg:mt-2 flex ">
            ...
            <div className=" p-2 md:px-4 lg:ml-3 lg:text-lg lg:px-0 ">
                <p className="text-lg font-semibold">Stay on top of trends by posting on time</p>
                <p className="text-gray-700 lg:text-md">Set up customizable streams that let you monitor trends and stay notified. Get actionable insights on the best times to post without the heavy data crunching.</p>
            </div>
        </div>
       </div>
    </div>
