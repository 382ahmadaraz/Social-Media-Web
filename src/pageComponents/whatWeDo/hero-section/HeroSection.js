         ...
         <div className="header-section  p-2 mb-20 sm:px-4 flex items-center justify-center relative  h-[70h]">
          <div className="header-text  px-5 sm:mt-3 sm:p-2 md:px-9 lg:px-0 lg:w-[45%] lg:font-semibold ">
            ...
            <img src={dot} alt="h1" className="absolute bottom-0 left-0 z-[-1]" />
               <img src={h1} alt="h1" className="lg:h-[250px] lg:w-[140px] xl:h-[320px] xl:w-[190px] 2xl:h-[360px] 2xl:w-[220px] rounded-xl z-[3] ml-3 2xl:ml-5" />
               <img src={h2} alt="h1" className="lg:h-[250px] lg:w-[140px] xl:h-[320px] xl:w-[190px] 2xl:h-[360px] 2xl:w-[220px] rounded-xl z-[3] ml-3 2xl:ml-5 relative top-16" />
               <img src={h3} alt="h1" className="lg:h-[250px] lg:w-[140px] xl:h-[320px] xl:w-[190px] 2xl:h-[360px] 2xl:w-[220px] rounded-xl z-[3] ml-3 2xl:ml-5" />
           </div></div>
