...
import ServiceData from "./WhatCardsData";
...
export default function ServiceCards() {
  return (
    <div className="p-4 my-16 lg:mt-14 2xl:p-11">
         ...
         <h1 className="text-2xl 2xl:text-5xl font-semibold text-center sm:text-4xl">OUR SERVICES</h1>
      ...
      <div className="lg:flex lg:flex-wrap justify-center lg:gap-11 ">
        {ServiceData.map((card) => (
          <div key={card.id} className=" mb-4 p-3 border-[1px] border-gray-300 lg:w-[42%] lg:h-[43%] text-sm  rounded-2xl lg:p-8" >
            <img src={card.url} alt={card.url} className="p-2 lg:p-4 rounded-xl bg-gradient-to-b from-Purple to-Pink lg:h-[70px]" />
            <h1 className="text-xl my-2 md:text-2xl 2xl:text-3xl lg:my-5 font-semibold">{card.title}</h1>
